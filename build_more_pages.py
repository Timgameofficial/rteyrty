...
render_page(
    ...
    depth=1,
    breadcrumbs=[("Головна","/"),("Послуги","/services/")],
)
...
render_page(
    ...
    description="Прайс-лист стоматології ST Кам'янське 2026: вініри від 18 500 грн, імплантація від 34 900 грн, гігієна від 2 200 грн. Без прихованих доплат.",
    canonical_path="/prices/",
    active_href="/prices/",
    main_html=prices_main,
    depth=1,
    breadcrumbs=[("Головна","/"),("Ціни","/prices/")],
)
...
render_page(
    ...
    main_html=team_main,
    depth=1,
    breadcrumbs=[("Головна","/"),("Команда","/team/")],
)
