...
render_page(
    path="faq/index.html",
    title="Питання про лікування зубів — FAQ | ST Стоматологія Київ",
    description="Відповіді на часті питання про вініри, імплантацію, розстрочку та біль після лікування в стоматології ST, Київ.",
    canonical_path="/faq/",
    active_href="/faq/",
    main_html=faq_main,
    depth=1,
...
render_page(
    ...
    title="Портфоліо стоматології Київ — фото до і після | ST",
